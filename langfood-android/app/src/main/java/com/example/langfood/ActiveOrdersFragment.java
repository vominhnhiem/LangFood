...
public class ActiveOrdersFragment extends Fragment {
    ...
    private void setupRecyclerViews() {
        ...
        // Active Orders
        ordersAdapter = new OrderHistoryAdapter(activeOrdersList);
        rvActiveOrders.setLayoutManager(new LinearLayoutManager(getContext()));
        rvActiveOrders.setAdapter(ordersAdapter);
    }
        ...
        apiService.getOrdersByBuyer(userId).enqueue(new Callback<List<Order>>() {
            ...
            public void onResponse(@NonNull Call<List<Order>> call, @NonNull Response<List<Order>> response) {
                ...
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    Collections.sort(activeOrdersList, (o1, o2) -> Integer.compare(o2.getId(), o1.getId()));
