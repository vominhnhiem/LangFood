...
namespace LangFoodBackend.Migrations
{
    ...
    [Migration("20260507210111_AddStutusproduct")]
    partial class AddStutusproduct
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LangFood.Shared.Models.Order", b =>
                {
                    ...
                    b.HasOne("LangFood.Shared.Models.User", "ExternalShipper")
                        .WithMany()
                        .HasForeignKey("ExternalShipperId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("LangFood.Shared.Models.User", "Shipper")
                        .WithMany()
            ...
            modelBuilder.Entity("LangFood.Shared.Models.Product", b =>
                {
                    ...
                    b.HasOne("LangFood.Shared.Models.User", "Seller")
                        .WithMany("Products")
