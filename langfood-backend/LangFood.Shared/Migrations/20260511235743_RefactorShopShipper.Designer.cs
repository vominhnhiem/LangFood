...
namespace LangFoodBackend.Migrations
{
    ...
    [Migration("20260511235743_RefactorShopShipper")]
    partial class RefactorShopShipper
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LangFood.Shared.Models.Order", b =>
                {
                    ...
                    b.Property<int?>("Leg1ShipperId")
                        .HasColumnType("int");

                    b.Property<int?>("Leg2ShipperId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("Leg1ShipperId");

                    b.HasIndex("Leg2ShipperId");
            ...
            modelBuilder.Entity("LangFood.Shared.Models.Order", b =>
                {
                    ...
                    b.HasOne("LangFood.Shared.Models.Shipper", "Leg1Shipper")
                        .WithMany("Leg1Orders")
                        .HasForeignKey("Leg1ShipperId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("LangFood.Shared.Models.Shipper", "Leg2Shipper")
                        .WithMany("Leg2Orders")
                        .HasForeignKey("Leg2ShipperId")
                        .OnDelete(DeleteBehavior.Restrict);
                    ...
                    b.Navigation("Leg1Shipper");

                    b.Navigation("Leg2Shipper");
            ...
            modelBuilder.Entity("LangFood.Shared.Models.Shipper", b =>
                {
                    b.Navigation("Leg1Orders");

                    b.Navigation("Leg2Orders");
                });
