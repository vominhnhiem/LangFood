...
{
    /// <inheritdoc />
    public partial class FinalFixRelationships : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    KtxBuilding = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    KtxRoom = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IsVerifiedResident = table.Column<bool>(type: "bit", nullable: false),
                    StudentCardImageUrl = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeliveryBuilding = table.Column<string>(type: "nvarchar(max)", nullable: true),
